...
NOT FOR PRODUCTION USE. NOT FOR PUBLIC DISTRIBUTION.
    ...
    'data': [
        ...
        'data/sim_scenario_data.xml',
        'views/sim_config_views.xml',
        'views/sim_product_views.xml',
        'views/sim_customer_views.xml',
        'views/sim_order_views.xml',
        'views/sim_location_views.xml',
        'views/sim_inventory_views.xml',
        'views/sim_fulfillment_views.xml',
        'views/sim_refund_views.xml',
        'views/sim_webhook_views.xml',
        'views/sim_collection_views.xml',
        'views/sim_metafield_views.xml',
        'views/sim_gift_card_views.xml',
        'views/sim_payout_views.xml',
        'views/sim_abandoned_cart_views.xml',
        'views/sim_discount_views.xml',
        'views/sim_scenario_views.xml',
        'views/sim_checklist_views.xml',
        'wizards/sim_seed_wizard_views.xml',
        'wizards/sim_webhook_console_views.xml',
        'views/sim_menu.xml',
    ],
    'installable': True,
    'application': False,
