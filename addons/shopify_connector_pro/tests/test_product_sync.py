...
class TestProductSync(TransactionCase):
    ...
    def test_product_binding_run_sync_calls_correct_direction(self):
        ...
        with patch('odoo.addons.shopify_connector_pro.sync.product_sync.ProductSync') as MockSync:
    ...
    def test_export_skips_unchanged_product(self):
        ...
        with patch('odoo.addons.shopify_connector_pro.sync.product_sync.ProductExporter._export_one') as mock_export:
