...
> Wave 0 reconciliation is recorded in `../04-decisions/DEC-033-mvp-wave-0-reconciliation.md` (Accepted 2026-07-15) and the dated official-source refresh `../01-research/wave-0-roles-permissions-and-fulfillment-scope-refresh.md`. Wave 1's internal packet dependency/sequencing reconciliation is recorded in `../04-decisions/DEC-034-wave-1-packet-dependency-reconciliation.md` — see that record before launching Wave 1.
