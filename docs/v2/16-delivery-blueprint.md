...
| F1 — install and identities | Repair Lite optional-owner schema access; canonical run name and explicit attempt number handling; then prove old-core W2 bridge against owning migrations | Focused regressions; actual fresh Lite/Full and old-core W2 installs; no optional-owner schema leakage; canonical immutable IDs |
