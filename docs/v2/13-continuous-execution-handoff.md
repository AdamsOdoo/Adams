...
- First next action: finish lead diff/compilation checks, commit the coherent correction, prepare tree-equivalent GitHub source plus exact-source evidence, and update PR #212 without force. Inspect its focused native artifact and repair the first residual root; allow the full campaign only after this prerequisite passes. Do not repeat a full campaign on known failed foundations.
