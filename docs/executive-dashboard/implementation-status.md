...
Native build38534772 (`b1d92f77`) produced the first populated Finance pair but failed one browser test: a print assertion reused the new card title instead of the report label. Build38535653 (`08c8d486`) produced corrected reference crops and exposed the equivalent PDF assertion. Both assertions are corrected in `b9a9cbb076700c4210b2143696c0336a216974a7`; its native run was still in progress at this checkpoint. Earlier platform errors are historical, not the current blocker.
