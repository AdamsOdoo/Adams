...
| unsupported assumption (#3) / weak research (#1) | 2 | **2nd (DP-003, DP-004)** — at the update-rule threshold. Prevention rule added: configuration fields ≠ demonstrated support, and a market-promise ≠ demonstrated bidirectionality; feature-matrix review must justify ✅ by a demonstrated workflow, not a visible field/generic claim. |
