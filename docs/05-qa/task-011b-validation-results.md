...
> per-run marker** as the benchmark corpus identity (no id-range). The
> accepted Task 011B **production design is unchanged** by either
> correction — both touch only the test file and the shared docs.
>
