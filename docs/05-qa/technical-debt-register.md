...
scope-naming concern, logged 2026-07-08 via the DEC-023 routing patch) is
currently **Open** — see the TD-002 row above. Research-only gaps and gated
