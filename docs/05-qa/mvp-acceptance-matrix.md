...
> applies every binding correction:
...
> control-room-accepted; Claude did not accept its own package.** Stage 0
> (Layer 2 core substrate) has a Sol implementation branch
