...
_**AR-045 renumber / base-sync note (2026-07-12, control-room base-
synchronization amendment).** The Task 010B row above was originally drafted
and pushed as **AR-044** (its four revision notes were "AR-044 revision note
1-4"). When `Shopify-connector` advanced to
`cfdb05703a65f82b34a9a11364aab6fc960cca9d` (PR #155, U0 acceptance closure),
the control room assigned **AR-044 to the U0 acceptance-closure row**. To
avoid a collision, on the base-sync merge into the Task 010B branch this row
and its four revision notes were renumbered from **AR-044 to AR-045** (the
next free ID; AR-044 was retained, not overwritten or combined, for U0).
Self-references to the Task 010B AR row elsewhere in the package
(`task-010b-validation-results.md`,
`task-010b-product-import-completeness-packet.md`, `research-handoff.md`)
were updated to **AR-045** in the same merge. The table stays
chronologically accurate — AR-045 (Task 010B, 2026-07-11) precedes AR-044
(U0, 2026-07-12) by date, even though its numeric ID is higher, because U0's
later acceptance was assigned the lower free ID by the control room. This
note records the renumber; it changes no Task 010B decision or evidence._
...
_**AR-045 revision note (2026-07-12, control-room static review `4950202231`
...
_**AR-045 revision note 2 (2026-07-12, control-room static review
...
_**AR-045 revision note 3 (2026-07-12, control-room static review
...
_**AR-045 revision note 4 (2026-07-12, control-room acceptance `4951264328`
...
_**AR-045 revision note 5 (2026-07-12, control-room base-synchronization
...
four revision notes **AR-044 → AR-045** (see the "AR-045 renumber / base-sync
note" above); U0 keeps AR-044 (not overwritten or combined). The two shared-doc
