...
| `reconciliation_order_days` | Integer | `addons/shopify_connector_pro/models/shopify_backend.py:209-212` | `addons/shopify_connector_pro/views/shopify_backend_views.xml:199-200` | Refund/reconciliation lookback. | Y | Y | N | MONEY-PATH | Can alter reconciliation scope. |
...
| Reconciliation lookback | Reconciliation reads `reconciliation_order_days` in `addons/shopify_connector_pro/models/shopify_reconciliation.py:172-176` and `addons/shopify_connector_pro/models/shopify_reconciliation.py:316`; refunds also use it in `addons/shopify_connector_pro/sync/refund_sync.py:619-645`. | Strict staged for reconciliation scope. |
