...
- Mappings ✅ · Multi-store ⬜ · Multi-company ⬜/➖ (default Company field visible, but true multi-company support/isolation not demonstrated) · Shopify Markets ⬜ · Metafields ➖ (metaobject scopes requested) · Gift cards ➖ (gift-card scopes requested) · POS ⬜ · B2B ⬜ · Permissions/security ⬜ (only Shopify scopes) · Reporting/analytics ⬜ · Configuration/settings ✅ · Troubleshooting/support ✅ (UV Desk) · Updates/release notes 🟨 (dates only, no changelog)
