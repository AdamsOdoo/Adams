...
4. Upgrade all installed connector addons together. For this candidate the versions are core `19.0.1.26.0`, product `19.0.2.14.0`, sale `19.0.2.15.0`, inventory `19.0.1.12.0`, fulfillment `19.0.1.10.0`, product export `19.0.1.6.0`, webhook `19.0.1.3.0`, product webhook `19.0.0.3.0`, inventory webhook `19.0.0.4.0`, sale webhook `19.0.0.1.0`, and fulfillment webhook `19.0.0.1.0`.
